...
def clipped_grad(params, l2_norm_clip, single_example_batch, loss, augmult=None):
    ...
    return tree_unflatten(tree_def, normalized_nonempty_grads), total_grad_norm, None
